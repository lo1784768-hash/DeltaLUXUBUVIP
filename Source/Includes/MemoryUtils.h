...
MemoryFileInfo getBaseInfo() {
    // Khoi tao ve 0 - neu vong lap khong tim thay anh nao khop (vd goi qua som, dyld chua kip nap
    // xong), _info.address phai la 0 de getAbsoluteAddress() phat hien duoc, khong phai rac tren stack.
