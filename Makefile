...
$(TWEAK_NAME)_FILES = Source/Menu.mm Source/fishhook.c Source/Generated/mach_excServer.c

# Source/Generated/mach_excServer.c là code sinh ra bởi `mig` (bước "Generate MIG exception
...
Source/Generated/mach_excServer.c:
	$(error Source/Generated/mach_excServer.c không tồn tại - chạy `mig` trước (xem .github/workflows/build.yml) hoặc build qua CI)
